    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagSubjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagSubjects_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TagSubjects_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagSubjects_SubjectId",
                table: "TagSubjects",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TagSubjects_TagId",
                table: "TagSubjects",
                column: "TagId");
